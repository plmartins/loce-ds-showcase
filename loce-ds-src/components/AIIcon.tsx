...
type AIIconProps = { size?: number; className?: string; };

function AIIcon({ size = 20, className }: AIIconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 512 512" fill="currentColor" className={cn("shrink-0", className)}>
